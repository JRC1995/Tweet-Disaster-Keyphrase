...
for disaster_type in test_tweets:
    ...
    with tf.Session(config=config) as sess:  # Start Tensorflow Session
        ...
        test_batches_sen, test_batches_string, test_batches_labels_1, test_batches_labels_2,\
            test_batches_true_seq_lens = bucket_and_batch.bucket_and_batch(
                test_tweets_vec[disaster_type], test_tweets[disaster_type], test_labels_1[disaster_type], test_labels_2[disaster_type],
                vocab2idx, 32, labels_set)
        ...
        for i in range(0, len(test_batches_sen)):
            ...
            cost, prediction, acc, = sess.run([model.loss,
                                              ...
                                              feed_dict={tf_sentences: test_batches_sen[i],
                                                         tf_sentences_string: test_batches_string[i],
        ...
        print(str(disaster_type)+" Test Loss= " +
