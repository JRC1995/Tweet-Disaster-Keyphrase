    ...
    with tf.Session(config=config) as sess:  # Start Tensorflow Session
        ...
        test_batches_sen, test_batches_string, test_batches_pos, \
            ...
            test_batches_true_seq_lens = bucket_and_batch.bucket_and_batch(
                test_tweets_vec[disaster_type], test_tweets[disaster_type],
                test_pos[disaster_type], test_ipa[disaster_type], test_phono[disaster_type],
                test_labels_1[disaster_type], test_labels_2[disaster_type],
